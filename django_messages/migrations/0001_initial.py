    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_msg', models.ForeignKey(related_name='next_messages', verbose_name='Parent message', on_delete=models.CASCADE, blank=True, to='django_messages.Message', null=True)),
                ('recipient', models.ForeignKey(related_name='received_messages', verbose_name='Recipient', on_delete=models.CASCADE, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('sender', models.ForeignKey(related_name='sent_messages', verbose_name='Sender', on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-sent_at'],
